                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="search-vehicle.php">Автобус хайх</a></li>
                                    <li class="active">Автобус хайх</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Автобус хайх</strong>
                        </div>
                        <div class="card-body">
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="search">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Автобусны дугаараар хайх</label></div>
                                   ...
                                   <p style="text-align: center;"> <button type="submit" class="btn btn-primary btn-sm" name="search" >Хайх</button></p>
                                </form>
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center">Таны хайсан өгөгдөл "<?php echo $sdata;?>"</h4> 
                             <table class="table">
                <thead>
                                        <tr>
                                            <tr>
