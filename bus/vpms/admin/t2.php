...
if(isset($_POST['submit']))
  {
    $t2buudliinner=$_POST['t2buudliinner'];
    $t2buudliinner2=$_POST['t2buudliinner2'];

    
     
    $query=mysqli_query($con, "insert into  t2(t2BuuliinNer,t2BuudliinNer2) value('$t2buudliinner','$t2buudliinner2')");
    if ($query) {
    echo "<script>alert('Автобусны чиглэл амжилттай бүртгэгдлээ');</script>";
echo "<script>window.location.href='ch2.php'</script>";
  }
  else
    {
        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Т:2 (Ботаник-5 шар )</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="t2buudliinner" name="t2buudliinner" class="form-control" placeholder="Өгөгдлөө оруулна уу..." required="true"></div>
                                    </div>                              
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Т:1 (5 шар-Ботаник)</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Дундын буудал:</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="t2buudliinner2" name="t2buudliinner2" class="form-control" placeholder="Өгөгдлөө оруулна уу..." required="true"></div>
                                    </div>                              
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Ботаник-5 шар</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                                <thead>
               ...
               <?php
$ret=mysqli_query($con,"select *from  t2");
$cnt=1;
...
?>
                ...
                <tr>
                  ...
                  <td><?php  echo $row['t2BuuliinNer'];?></td>
...
$cnt=$cnt+1;
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">5 шар-Ботаник</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                                <thead>
...
?>
                ...
                <tr>
                  ...
                  <td><?php  echo $row['t2BuudliinNer2'];?></td>
