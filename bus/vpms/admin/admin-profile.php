                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="admin-profile.php">Хаяг</a></li>
                                    <li class="active">Админ хаяг</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
?>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Админ нэр</label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="password-input" class=" form-control-label">Утасны дугаар</label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Цахим хаяг</label></div>
                                    ...
                                    <?php } ?>
                                   <p style="text-align: center;"> <button type="submit" class="btn btn-primary btn-sm" name="submit" >Засах</button></p>
                                </form>
                            </div>
