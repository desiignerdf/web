   ...
   <?php include_once('includes/header.php');?>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="bwdates-report-ds.php">Тайлан</a></li>
                                    <li class="active">Тайлан</li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Эхлэх өдөр</label></div>
                                        <div class="col-12 col-md-9"><input type="date" name="fromdate" id="fromdate" class="form-control" required="true"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Дуусах өдөр</label></div>
                                   ...
                                   <p style="text-align: center;"> <button type="submit" class="btn btn-primary btn-sm" name="submit" >Шүүх</button></p>
                                </form>
                            </div>
